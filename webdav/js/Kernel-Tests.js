...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_", [smalltalk.send(smalltalk.send(function () {return 2;}, "_compiledSource", []), "_includesSubString_", ["function"])]);
    return self;
},
args: [],
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function () {return 2;}, "_value", []), 2]);
...
smalltalk.addClass('FunctionalOperatorTest', smalltalk.TestCase, [], 'Kernel-Tests');
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_", [smalltalk.send(2.5, "__eq", [2.5])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(1, "__eq", [1])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(-3, "__eq", [-3])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(6, "__eq", [6])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(12, "__eq", [12])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(($receiver = 3).klass === smalltalk.Number ? $receiver * 3 : smalltalk.send($receiver, "__star", [3]), "__eq", [9])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(7, "__eq", [7])]);
    return self;
},
args: [],
...
fn: function () {
    ...
    smalltalk.send(self, "_deny_", [smalltalk.send(($receiver = smalltalk.send(smalltalk.Object || Object, "_new", [])) == nil ||
        $receiver == undefined ? function () {return true;}() : $receiver, "__eq", [true])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(($receiver = smalltalk.send(smalltalk.Object || Object, "_new", [])) != nil &&
        $receiver != undefined ? function () {return true;}() : nil, "__eq", [true])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(($receiver = smalltalk.send(smalltalk.Object || Object, "_new", [])) == nil ||
        $receiver == undefined ? function () {return false;}() : function () {return true;}(), "__eq", [true])]);
    smalltalk.send(self, "_assert_", [smalltalk.send(($receiver = smalltalk.send(smalltalk.Object || Object, "_new", [])) == nil ||
        $receiver == undefined ? function () {return false;}() : function () {return true;}(), "__eq", [true])]);
    return self;
},
...
smalltalk.addClass('PipelineOperatorTest', smalltalk.TestCase, [], 'Kernel-Tests');
smalltalk.addMethod(
"_testDefault",
smalltalk.method({
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(1, "_default_", [3]), 1]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(nil, "_default_", [3]), 3]);
    return self;
},
args: [],
source: "testDefault\x0a\x09self assert: ( 1 default: 3 ) equals: 1.\x0a\x09self assert: ( nil default: 3 ) equals: 3.\x0a\x0a",
messageSends: ["assert:equals:", "default:"],
referencedClasses: []
}),
smalltalk.PipelineOperatorTest);

smalltalk.addMethod(
"_testNoProcess",
smalltalk.method({
selector: "testNoProcess",
category: 'not yet classified',
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(nil, "_|_gt", [function (thisisplaceholder1) {return smalltalk.send(thisisplaceholder1, "_asString", []);}]), nil]);
    smalltalk.send(self, "_assert_equals_", [function ($rec) {smalltalk.send($rec, "_|_gt", [function (thisisplaceholder1) {return smalltalk.send(thisisplaceholder1, "_add_", [1]);}]);smalltalk.send($rec, "_|_gt", [function (thisisplaceholder1) {return smalltalk.send(thisisplaceholder1, "_add_", [2]);}]);return smalltalk.send($rec, "_yourself", []);}(nil), nil]);
    return self;
},
args: [],
source: "testNoProcess\x0a\x09self assert: ( nil |> [ %1 asString ]) equals: nil.\x0a\x09self assert: ( nil |> [ %1 add: 1]; |> [%1 add: 2]; yourself ) equals: nil",
messageSends: ["assert:equals:", "|>", "asString", "add:", "yourself"],
referencedClasses: []
}),
smalltalk.PipelineOperatorTest);
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(1, "_|_gt", [function (thisisplaceholder1) {return smalltalk.send(thisisplaceholder1, "_asString", []);}]), "1"]);
    smalltalk.send(self, "_assert_equals_", [function ($rec) {smalltalk.send($rec, "_|_gt", [function (thisisplaceholder1) {return smalltalk.send(thisisplaceholder1, "_add_", [1]);}]);smalltalk.send($rec, "_|_gt", [function (thisisplaceholder1) {return smalltalk.send(thisisplaceholder1, "_add_", [2]);}]);return smalltalk.send($rec, "_yourself", []);}(smalltalk.send(smalltalk.Array || Array, "_new", [])), [1, 2]]);
    return self;
},
args: [],
source: "testPipe\x0a\x09self assert: ( 1 |> [ %1 asString ]) equals: '1'.\x0a\x09self assert: ( Array new |> [ %1 add: 1]; |> [%1 add: 2]; yourself ) equals: { 1. 2.}",
messageSends: ["assert:equals:", "|>", "asString", "add:", "yourself", "new"],
referencedClasses: ["Array"]
}),
smalltalk.PipelineOperatorTest);
...
smalltalk.addClass('PlaceHolderTest', smalltalk.TestCase, [], 'Kernel-Tests');
smalltalk.addMethod(
"_testAssign",
smalltalk.method({
selector: "testAssign",
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {var x = nil;x = thisisplaceholder1;return x;}, "_value_", [2]), 2]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, x) {x = thisisplaceholder1;return x;}, "_value_", [3]), 3]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {thisisplaceholder1 = 3;return thisisplaceholder1;}, "_value_", [4]), 3]);
    return self;
},
args: [],
source: "testAssign\x0a\x09self assert: ([ | x | x := %1. x] value: 2) equals: 2. \x0a\x09self assert: ([ :x | x := %1. x ] value: 3) equals: 3.\x0a\x09self assert: ([ %1 := 3. %1 ] value: 4) equals: 3",
messageSends: ["assert:equals:", "value:"],
referencedClasses: []
}),
smalltalk.PlaceHolderTest);
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2) {return function ($rec) {smalltalk.send($rec, "_add_", [thisisplaceholder1]);smalltalk.send($rec, "_add_", [thisisplaceholder2]);smalltalk.send($rec, "_add_", [thisisplaceholder1]);return smalltalk.send($rec, "_yourself", []);}(smalltalk.send(smalltalk.Array || Array, "_new", []));}, "_value_value_", [1, 2]), [1, 2, 1]]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2) {return function ($rec) {smalltalk.send($rec, "_add_", [1]);smalltalk.send($rec, "_add_", [2]);smalltalk.send($rec, "_add_", [thisisplaceholder2]);return smalltalk.send($rec, "_yourself", []);}(thisisplaceholder1);}, "_value_value_", [smalltalk.send(smalltalk.Array || Array, "_new", []), 3]), [1, 2, 3]]);
    return self;
},
args: [],
source: "testCascade\x0a\x09self assert: ( [ Array new add: %1; add: %2; add:  %1 ; yourself] value: 1 value: 2 ) equals: { 1. 2. 1 }.\x0a\x09self assert: ( [ %1 add: 1; add: 2; add: %2; yourself] value: (Array new) value: 3 ) equals: { 1. 2. 3 }\x0a\x09",
messageSends: ["assert:equals:", "value:value:", "add:", "yourself", "new"],
referencedClasses: ["Array"]
}),
smalltalk.PlaceHolderTest);
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2, thisisplaceholder3) {return [thisisplaceholder1, thisisplaceholder3, thisisplaceholder2];}, "_value_value_value_", ["a", "b", "c"]), ["a", "c", "b"]]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2, thisisplaceholder3) {return [thisisplaceholder1, thisisplaceholder3, thisisplaceholder2, smalltalk.send(thisisplaceholder3, "__comma", [thisisplaceholder2])];}, "_value_value_value_", ["a", "b", "c"]), ["a", "c", "b", "cb"]]);
    return self;
},
args: [],
source: "testDynamicArray\x0a\x09self assert: ([ { %1. %3. %2 } ] value: 'a' value: 'b' value: 'c') equals: {'a'. 'c'. 'b'}.\x0a\x09self assert: ([ { %1. %3. %2. %3, %2} ] value: 'a' value: 'b' value: 'c') equals: {'a'. 'c'. 'b'. 'cb'}\x0a\x09",
messageSends: ["assert:equals:", "value:value:value:", ","],
referencedClasses: []
}),
smalltalk.PlaceHolderTest);
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {return smalltalk.send(function (thisisplaceholder1) {return thisisplaceholder1;}, "_value_", [thisisplaceholder1]);}, "_value_", [2]), 2]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {return ($receiver = thisisplaceholder1).klass === smalltalk.Number ? $receiver + smalltalk.send(function (thisisplaceholder1) {return thisisplaceholder1;}, "_value_", [3]) : smalltalk.send($receiver, "__plus", [smalltalk.send(function (thisisplaceholder1) {return thisisplaceholder1;}, "_value_", [3])]);}, "_value_", [2]), 5]);
    return self;
},
args: [],
source: "testNest\x0a\x09self assert: ([ [ %1] value: %1 ] value: 2) equals: 2.\x0a\x09self assert: ([ %1 + ([ %1 ] value: 3) ] value: 2) equals: 5\x0a",
messageSends: ["assert:equals:", "value:", "+"],
referencedClasses: []
}),
smalltalk.PlaceHolderTest);
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {return thisisplaceholder1;}, "_numArgs", []), 1]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2) {return ($receiver = thisisplaceholder1).klass === smalltalk.Number ? $receiver + thisisplaceholder2 : smalltalk.send($receiver, "__plus", [thisisplaceholder2]);}, "_numArgs", []), 2]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2, x) {return ($receiver = thisisplaceholder1).klass === smalltalk.Number ? $receiver + thisisplaceholder2 : smalltalk.send($receiver, "__plus", [thisisplaceholder2]);}, "_numArgs", []), 3]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2, x, y) {return ($receiver = thisisplaceholder1).klass === smalltalk.Number ? $receiver + thisisplaceholder2 : smalltalk.send($receiver, "__plus", [thisisplaceholder2]);}, "_numArgs", []), 4]);
    return self;
},
args: [],
source: "testNumArgs\x0a\x09self assert: [ %1 ] numArgs equals: 1.\x0a\x09self assert: [ %1 + %2 ] numArgs equals: 2.\x0a\x09self assert: [ :x | %1 + %2 ] numArgs equals: 3.\x0a\x09self assert: [ :x :y | %1 + %2 ] numArgs equals: 4\x0a",
messageSends: ["assert:equals:", "numArgs", "+"],
referencedClasses: []
}),
smalltalk.PlaceHolderTest);
...
fn: function () {
    ...
    var $early = {};
    try {
        smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {return function () {throw $early = [thisisplaceholder1];}();}, "_value_", [1]), 1]);
        smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {return function () {throw $early = [($receiver = thisisplaceholder1).klass === smalltalk.Number ? $receiver + thisisplaceholder1 : smalltalk.send($receiver, "__plus", [thisisplaceholder1])];}();}, "_value_", [1]), 2]);
        return self;
    } catch (e) {
        if (e === $early) {
            return e[0];
...
args: [],
source: "testReturn\x0a\x09self assert: ([ ^ %1 ] value: 1 ) equals: 1.\x0a\x09self assert: ([ ^ %1 + %1] value: 1 ) equals: 2.\x0a\x09",
messageSends: ["assert:equals:", "value:", "+"],
referencedClasses: []
}),
smalltalk.PlaceHolderTest);
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {return ($receiver = thisisplaceholder1).klass === smalltalk.Number ? $receiver + thisisplaceholder1 : smalltalk.send($receiver, "__plus", [thisisplaceholder1]);}, "_value_", [2]), 4]);
    return self;
},
args: [],
source: "testTwice\x0a\x09self assert: ([ %1 + %1 ] value: 2 ) equals: 4\x0a\x0a\x0a",
messageSends: ["assert:equals:", "value:", "+"],
referencedClasses: []
}),
smalltalk.PlaceHolderTest);
...
fn: function () {
    var self = this;
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1) {return thisisplaceholder1;}, "_value_", [2]), 2]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2) {return ($receiver = thisisplaceholder1).klass === smalltalk.Number ? $receiver - thisisplaceholder2 : smalltalk.send($receiver, "__minus", [thisisplaceholder2]);}, "_value_value_", [2, 5]), -3]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2) {return ($receiver = thisisplaceholder2).klass === smalltalk.Number ? $receiver - thisisplaceholder1 : smalltalk.send($receiver, "__minus", [thisisplaceholder1]);}, "_value_value_", [2, 5]), 3]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, x) {return ($receiver = x).klass === smalltalk.Number ? $receiver - thisisplaceholder1 : smalltalk.send($receiver, "__minus", [thisisplaceholder1]);}, "_value_value_", [2, 3]), 1]);
    smalltalk.send(self, "_assert_equals_", [smalltalk.send(function (thisisplaceholder1, thisisplaceholder2, x) {return smalltalk.send(smalltalk.send(smalltalk.send(x, "_asString", []), "__comma", [smalltalk.send(thisisplaceholder1, "_asString", [])]), "__comma", [smalltalk.send(thisisplaceholder2, "_asString", [])]);}, "_value_value_value_", [1, 2, 3]), "312"]);
    return self;
},
args: [],
source: "testValue\x0a\x09self assert: ([ %1 ] value: 2) equals: 2.\x0a\x09self assert: ([ %1 - %2 ] value: 2 value: 5) equals: -3.\x0a\x09self assert: ([ %2 - %1 ] value: 2 value: 5) equals: 3.\x0a\x09self assert: ([ :x | x - %1 ] value: 2 value: 3) equals: 1.\x0a\x09self assert: ([ :x | x asString, %1 asString, %2 asString ] value: 1 value: 2 value: 3 ) equals: '312'\x0a\x0a",
messageSends: ["assert:equals:", "value:", "value:value:", "-", "value:value:value:", ",", "asString"],
referencedClasses: []
}),
smalltalk.PlaceHolderTest);
