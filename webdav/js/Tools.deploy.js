...
smalltalk.addClass('DialogBox', smalltalk.Widget, ['message', 'option', 'body', 'aspectRatio'], 'Tools');
smalltalk.addMethod(
'_body',
smalltalk.method({
selector: 'body',
...
smalltalk.addClass('ImageEditor', smalltalk.DialogBox, ['img', 'canvas', 'jcrop'], 'Tools');
smalltalk.addMethod(
'_area',
smalltalk.method({
selector: 'area',
...
smalltalk.addClass('Circle', smalltalk.Widget, [], 'Tools');
smalltalk.addMethod(
'_renderOn_',
smalltalk.method({
selector: 'renderOn:',
