...
args: ["html"],
source: "renderOn: html\x0a\x09html div \x0a\x09\x09style: (self style);\x0a\x09\x09with: [ self renderBodyOn: html ];\x0a\x09\x09|> [ %1 asJQuery draggable: (self dragOption)]\x0a",
messageSends: ["style:", "style", "with:", "renderBodyOn:", "|>", "draggable:", "asJQuery", "dragOption", "div"],
referencedClasses: []
}),
smalltalk.DraggableWidget);
...
args: [],
source: "addToDSTokai\x0a  window open: (self gcalUrl: self dstokaiId description: self descriptionForDSTokai) target: '_blank'",
...
args: [],
source: "latest\x0a\x09^ self meeting08",
messageSends: ["meeting08"],
referencedClasses: []
}),
smalltalk.Event.klass);
...
args: [],
source: "stStudyGodo02\x0a\x09^ self new \x0a\x09\x09fixed: true;\x0a\x09\x09title: '合同Smalltalk勉強会@名古屋';\x0a\x09\x09date: '2012/09/29';\x0a\x09\x09start: '13:30:00';\x0a\x09\x09end: '18:00:00';\x0a\x09\x09place: ATeam;\x0a\x09\x09detail: {\x0a'参照(http://atnd.org/events/30524)'\x0a}",
messageSends: ["fixed:", "title:", "date:", "start:", "end:", "place:", "detail:", "new"],
referencedClasses: ["ATeam"]
}),
smalltalk.Event.klass);
...
smalltalk.addClass('JointStStudy', smalltalk.Object, [], 'DyNagoya');
...
fn: function () {
    var self = this;
    return "\nLinks show.\nAboutDyNagoya show.\nBrowser open.\nEvent browser onDialog\nEvent browser onPage\nTopPage show\neditor := ProxyImageEditor open: 'http://cdn-ak.f.st-hatena.com/images/fotolife/c/chun_it/20080512/20080512162247.jpg'\neditor scale: 2.0.\nLogo browser onPage openMethod: 'imageUrl'.\nTopPage show.\nLogo browser onPage openMethod: 'x'.\nScreen title: 'About Amber Smalltalk'.\nScreen add: (Amber goodPoint at:1).\nScreen title: 'About Place Holder'.\nScreen add: [ :html | html h2: 'Smalltalk \u306F\u30D6\u30ED\u30C3\u30AF\uFF08\u7121\u540D\u95A2\u6570\uFF09\u3092\u3088\u304F\u4F7F\u3044\u307E\u3059']\nScreen add: [ :html | html h2: '\u5F15\u6570\u3092\u66F8\u304F\u306E\u304C\u5104\u52AB' ].\nScreen add: [ %1 h2: 'Clojure\u98A8\u306B\u66F8\u304D\u305F\u3044' ].\n(1 to: 10) inject: 0 into: [ %1 + %2 ]. \nScreen add: [ it h2: 'Groovy\u98A8\u306A\u3089\u3053\u3093\u306A\u304B\u3093\u3058'].\nParserEditor  onDialog \nScreen add: [ _ h2: 'Scala\u98A8\u306A\u3089\u3053\u3093\u306A\u304B\u3093\u3058'].\n(1 to: 10) inject: 0 into: [ _ + _ ]. \nObject browser onPage openMethod: '|>'.\nScreen put: PipelineDesc new.\nPipelineDesc new |> [ Screen put: %1].\nDraggableWidget browser onPage openMethod: 'renderOn:'.\nDraggableWidget browser onPage openMethod: 'style'.\nEntryPoint browser onPage openClassMethod: 'start'\n";
    return self;
},
args: [],
source: "agenda02\x0a\x09^ '\x0aLinks show.\x0aAboutDyNagoya show.\x0aBrowser open.\x0aEvent browser onDialog\x0aEvent browser onPage\x0aTopPage show\x0aeditor := ProxyImageEditor open: ''http://cdn-ak.f.st-hatena.com/images/fotolife/c/chun_it/20080512/20080512162247.jpg''\x0aeditor scale: 2.0.\x0aLogo browser onPage openMethod: ''imageUrl''.\x0aTopPage show.\x0aLogo browser onPage openMethod: ''x''.\x0aScreen title: ''About Amber Smalltalk''.\x0aScreen add: (Amber goodPoint at:1).\x0aScreen title: ''About Place Holder''.\x0aScreen add: [ :html | html h2: ''Smalltalk はブロック（無名関数）をよく使います'']\x0aScreen add: [ :html | html h2: ''引数を書くのが億劫'' ].\x0aScreen add: [ %1 h2: ''Clojure風に書きたい'' ].\x0a(1 to: 10) inject: 0 into: [ %1 + %2 ]. \x0aScreen add: [ it h2: ''Groovy風ならこんなかんじ''].\x0aParserEditor  onDialog \x0aScreen add: [ _ h2: ''Scala風ならこんなかんじ''].\x0a(1 to: 10) inject: 0 into: [ _ + _ ]. \x0aObject browser onPage openMethod: ''|>''.\x0aScreen put: PipelineDesc new.\x0aPipelineDesc new |> [ Screen put: %1].\x0aDraggableWidget browser onPage openMethod: ''renderOn:''.\x0aDraggableWidget browser onPage openMethod: ''style''.\x0aEntryPoint browser onPage openClassMethod: ''start''\x0a'",
messageSends: [],
referencedClasses: []
}),
smalltalk.JointStStudy.klass);
...
args: ["html"],
source: "renderBody: html\x0a\x09\x09html div \x0a\x09\x09\x09with: Dolphin new;\x0a\x09\x09\x09with: Logo new;\x0a\x09\x09\x09with: Board new\x22;\x0a\x09\x09\x09with: Announcement new\x22\x0a",
...
args: ["aPage"],
source: "flip: aPage\x0a\x09self rollOut: (self current).\x0a\x09self nextIndex.\x0a\x09page := aPage.\x0a\x09aPage updateToJQuery: (self current).\x0a\x09self rollIn: (self current)",
messageSends: ["rollOut:", "current", "nextIndex", "updateToJQuery:", "rollIn:"],
referencedClasses: []
}),
smalltalk.Screen);
