...
args: ["aPage"],
source: "flip: aPage\x0a\x09self zoom: aPage",
messageSends: ["zoom:"],
referencedClasses: []
}),
smalltalk.Screen);
...
args: [],
source: "normalize\x0a  ^ (< { skewX: '0deg', \x0a    scale: 1.0, x: 0, \x0a    rotate: '0', opacity: 1, \x0a    perspective: '0px',\x0a    rotateX: '0deg',\x0a    duration: 2000 } >)",
messageSends: [],
referencedClasses: []
}),
smalltalk.Screen);
...
args: ["jq"],
source: "zoomOut: jq\x0a  jq transition: (< { scale:3.0, opacity: 0, \x0a    perspective: '100px',\x0a    rotateX: '180deg',\x0a    duration: 2000 } >) callback: [ jq hide ]",
messageSends: ["transition:callback:", "hide"],
referencedClasses: []
}),
smalltalk.Screen);
