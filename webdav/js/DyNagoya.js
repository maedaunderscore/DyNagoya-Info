...
args: [],
source: "normalize\x0a  ^ (< { skewX: '0deg', scale: 1.0, x: 0, rotate: '0', opacity: 1, duration: 2000 } >)",
messageSends: [],
referencedClasses: []
}),
smalltalk.Screen);
...
args: ["jq"],
source: "rollIn: jq\x0a  jq show; \x0a\x09css: (< { x: -100, rotate: '-15deg'} >);\x0a\x09|> [ %1 transition: self normalize ]",
...
args: ["jq"],
source: "zoomOut: jq\x0a  jq transition: (< { scale:3.0, opacity: 0, duration: 2000 } >) callback: [ jq hide ]",
messageSends: ["transition:callback:", "hide"],
referencedClasses: []
}),
smalltalk.Screen);
