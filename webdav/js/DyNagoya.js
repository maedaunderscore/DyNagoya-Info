...
args: [],
source: "start\x0a  workspace ifNil: [ workspace := DialogBox new widget: (Workspace new); x: '600px'; width: '300px'; title: 'Workspace'; modal: false].\x0a\x22  self makeWorkspaceBigTheme.\x22\x0a  transcript ifNil: [ transcript :=DialogBox new widget: (IDETranscript current);  x: '600px'; height: 300; width: '500px'; title: 'Transcript'; modal: false ].\x0a\x0a  workspace  y: self positionY; open.\x0a  transcript y: self positionY ; open.\x0a\x0a   self screenPreparation.\x0a  LoginPanel show.\x0a  self showMessage.",
messageSends: ["ifNil:", "widget:", "new", "x:", "width:", "title:", "modal:", "current", "height:", "y:", "positionY", "open", "screenPreparation", "show", "showMessage"],
