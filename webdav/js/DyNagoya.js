...
args: [],
source: "tweetMessage\x0a\x09^ '次回のミーティングは',\x0a\x09(self formatPeriod),\x0a\x09' 場所:', (place name),\x0a\x09' で開催します。参加登録はこちら → http://dynagoya.info/'",
...
args: ["html"],
source: "body: html\x0a\x09html a \x0a\x09\x09href:'#';\x0a\x09\x09onClick: [ Links new open. false ];\x0a\x09\x09css: 'font-size' put: '24px';\x0a\x09\x09css: 'color' put: 'white';\x0a\x09\x09with: 'Links'",
messageSends: ["href:", "onClick:", "open", "new", "css:put:", "with:", "a"],
referencedClasses: ["Links"]
}),
smalltalk.LinkMenu);
...
args: [],
source: "style\x0a  ^ 'top:250px;left:280px;background:red;'",
messageSends: [],
referencedClasses: []
}),
smalltalk.LinkMenu);
...
args: ["aPage"],
source: "flip: aPage\x0a\x09self rollOut: (self current).\x0a\x09self nextIndex.\x0a\x09aPage updateToJQuery: (self current).\x0a\x09self rollIn: (self current)",
...
fn: function (html) {
    var self = this;
    (function ($rec) {smalltalk.send($rec, "_id_", ["screen"]);return smalltalk.send($rec, "_with_", [function () {smalltalk.send(smalltalk.send(html, "_div", []), "_id_", ["layer1"]);return smalltalk.send(smalltalk.send(html, "_div", []), "_id_", ["layer2"]);}]);}(smalltalk.send(html, "_div", [])));
    return self;
},
args: ["html"],
source: "renderOn: html\x0a\x09html div id: 'screen'; with: [\x0a\x09\x09html div id: 'layer1'.\x0a\x09\x09html div id: 'layer2'\x0a\x09]",
messageSends: ["id:", "with:", "div"],
referencedClasses: []
}),
smalltalk.Screen);
