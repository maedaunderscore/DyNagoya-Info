...
args: [],
source: "grammer Sessions:list > sessions\x0a〜タイムスケジュールを決める〜 : 15min!\x0aモナモナいうモナド入門[@hiratara] : 105min!\x0a休憩 : 15min!\x0aCoqによるMaybeモナドを証明(+ Coq入門)[@mzp] : 30min!\x0a休憩 : 5min!\x0aCoqによるKleisli構成の説明[@t6s] : 44min!\x0a休憩 : 6min!\x0aモッジとワドラー[@t6s] : 20min\x0a休憩 : 10min\x0a余モナド[@uskz] : 50min\x0a〜 懇親会（ビアバッシュ） 〜 : 130min\x0a",
messageSends: [],
referencedClasses: []
}),
smalltalk.Wakame);
