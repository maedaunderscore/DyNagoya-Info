...
fn: function (name, aValue) {
    var self = this;
    smalltalk.send(smalltalk.send(self, "_asJQuery", []), "_css_put_", [name, aValue]);
    return self;
},
args: ["name", "aValue"],
source: "css: name put: aValue\x0a    self asJQuery css: name put: aValue",
...
"_updateToJQuery_",
smalltalk.method({
selector: "updateToJQuery:",
category: 'adding',
fn: function (aJQuery) {
    var self = this;
    smalltalk.send(aJQuery, "_html_", [""]);
    smalltalk.send(self, "_appendToJQuery_", [aJQuery]);
    return self;
},
args: ["aJQuery"],
source: "updateToJQuery: aJQuery\x0a   aJQuery html: ''.\x0a   self appendToJQuery: aJQuery",
messageSends: ["html:", "appendToJQuery:"],
referencedClasses: []
}),
smalltalk.Widget);
