    ...
    parse: function(input, startRule) {
      ...
      function parse_varIdentifier() {
        ...
        var result9 = result8 !== null
          ? (function(first, others) {return first + others.join("")})(result8[0], result8[1])
          : null;
        if (result9 !== null) {
          var result7 = result9;
        } else {
      ...
      function parse_dynamicArray() {
        ...
        if (result3 !== null) {
          var result4 = parse_ws();
          if (result4 !== null) {
            var result10 = parse_expressions();
