...
fn: function (html) {
    ...
    var div = nil;
    div = smalltalk.send(html, "_div", []);
    (function ($rec) {smalltalk.send($rec, "_css_put_", ["background", "#b0430b"]);smalltalk.send($rec, "_class_", ["animated"]);smalltalk.send($rec, "_css_put_", ["color", "white"]);smalltalk.send($rec, "_css_put_", ["width", "500px"]);smalltalk.send($rec, "_css_put_", ["z-index", "1"]);smalltalk.send($rec, "_c