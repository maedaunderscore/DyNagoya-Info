...
fn: function (aNode) {
    ...
    (function ($rec) {smalltalk.send($rec, "_nextPutAll_", [smalltalk.send(smalltalk.send("source: ", "__comma", [smalltalk.send(smalltalk.send(self, "_source", []), "_asJavascript", [])]), "__comma", [","])]);return smalltalk.send($rec, "_lf", []);}(self['@stream']));
    (function ($rec) {smalltalk.send($rec, "_nextPutAll_", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send("fn:function(){ \n\t\t\tif(", "__comma", [jsMethod]), "__comma", [" == null){ "]), "__comma", [jsParser]), "__comma", ["}\n\t\t\treturn "]), "__comma", [jsMethod]), "__comma", [";\n\t\t\t},"])]);smalltalk.send($rec, "_lf", []);return smalltalk.send($rec, "_nextPutAll_", ["\n\t\t\targs: [],messageSends: [],referencedClasses: []})"]);}(self['@stream']));
    return self;
},
args: ["aNode"],
source: "visitOMetaDefineNode: aNode\x0a\x09| jsMethod jsParser tree | \x0a\x09nestedBlocks := 0.\x0a\x09earlyReturn := false.\x0a\x0a\x22\x09jsMethod := 'smalltalk.', (self methodName: currentClass), '.', aNode name.\x22\x0a\x09jsMethod := aNode name.\x0a\x09tree := BSOMetaJSParser matchAll: aNode body rule: 'topLevel'.\x0a\x09jsParser := BSOMetaJSTranslator match:tree rule:'trans'.\x0a\x0a\x09< eval(jsMethod + \x22 = null \x22) >.\x0a\x09stream \x0a\x09    nextPutAll: 'smalltalk.method({'; lf;\x0a\x09    nextPutAll: 'selector: \x22', aNode name, '\x22,'; lf.\x0a\x09stream nextPutAll: 'source: ', self source asJavascript, ',';lf.\x0a\x09stream \x0a\x09\x09nextPutAll: 'fn:function(){ \x0a\x09\x09\x09if(', jsMethod , ' == null){ ', jsParser, '}\x0a\x09\x09\x09return ', jsMethod , ';\x0a\x09\x09\x09},';lf;\x0a\x09\x09nextPutAll: '\x0a\x09\x09\x09args: [],messageSends: [],referencedClasses: []})'.",
messageSends: ["name", "matchAll:rule:", "body", "match:rule:", "nextPutAll:", "lf", ",", "asJavascript", "source"],
