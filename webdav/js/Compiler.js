...
args: ["aNode"],
source: "visitOMetaDefineNode: aNode\x0a\x09| jsMethod jsParser tree | \x0a\x09nestedBlocks := 0.\x0a\x09earlyReturn := false.\x0a\x0a\x22\x09jsMethod := 'smalltalk.', (self methodName: currentClass), '.', aNode name.\x22\x0a\x09jsMethod := aNode name.\x0a\x09tree := BSOMetaJSParser matchAll: aNode body rule: 'topLevel'.\x0a\x09jsParser := BSOMetaJSTranslator match:tree rule:'trans'.\x0a\x0a\x09< eval(jsMethod + \x22 = null \x22) >.\x0a\x09stream \x0a\x09    nextPutAll: 'smalltalk.method({'; lf;\x0a\x09    nextPutAll: 'selector: \x22', aNode name, '\x22,'; lf.\x0a\x09stream nextPutAll: 'source: ', self source asJavascript, ',';lf.\x0a\x09stream \x0a\x09\x09nextPutAll: 'fn:function(){ \x0a\x09\x09\x09if( typeof ', jsMethod, ' === \x22undefined\x22 || ', jsMethod , ' == null){ ', jsParser, '}\x0a\x09\x09\x09return ', jsMethod , ';\x0a\x09\x09\x09},';lf;\x0a\x09\x09nextPutAll: '\x0a\x09\x09\x09args: [],messageSends: [],referencedClasses: []})'.",
