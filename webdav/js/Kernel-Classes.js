...
fn: function () {
    ...
    ($receiver = smalltalk.send(self, "_superclass", [])) != nil &&
        $receiver != undefined ? function () {return smalltalk.send(result, "_addAll_", [smalltalk.send(smalltalk.send(self, "_superclass", []), "_allInstanceVariableNames", [])]);}() : nil;
    return result;
    return self;
},
args: [],
...
fn: function () {
    var self = this;
    return ($receiver = smalltalk.send(self, "_basicAt_", ["comment"])) == nil ||
...
fn: function () {
    var self = this;
    return ($receiver = smalltalk.send(self, "_package", [])) == nil ||
        $receiver == undefined ? function () {return "Unclassified";}() : function () {return smalltalk.send(smalltalk.send(self, "_package", []), "_name", []);}();
    return self;
},
args: [],
